      ...
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-24 text-center max-w-2xl mx-auto">
          ...
          <motion.h2
            ...
            className="font-serif text-[42px] md:text-[56px] text-regirl-charcoal leading-[1.1] mb-8"
          >
            Luxe, éthique & <span className="italic font-accent text-regirl-burgundy">excellence.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="font-sans font-light text-[17px] text-regirl-charcoal-muted leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24">
          {features.map((feature, idx) => (
            ...
            >
              <span className="font-ui text-[12px] text-regirl-burgundy/40 font-bold mb-8 group-hover:text-regirl-burgundy transition-colors duration-500">
                {feature.num}
              </span>
              <div className="text-regirl-burgundy mb-10 transition-transform duration-500 group-hover:scale-110 origin-left">
                {feature.icon}
              </div>
              <h3 className="font-serif text-[24px] text-regirl-charcoal mb-6">
                {feature.title}
              </h3>
              <p className="font-sans font-light text-[15px] text-regirl-charcoal-muted leading-[1.7] max-w-[280px]">
                {feature.desc}
              </p>
            </motion.div>
          ))}

...
export function SplitTexture({ textureImageUrl }: SplitTextureProps) {
  return (
    <section className="w-full min-h-[80vh] flex flex-col md:flex-row bg-white">
      ...
      {/* Right: Content */}
      <div className="w-full md:w-[45%] bg-irun-nude p-12 md:p-[8%] flex flex-col justify-center relative overflow-hidden">
        {/* Subtle Background Pattern or Accent */}
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-irun-terracotta/5 rounded-full blur-3xl" />
        
        <motion.span
          initial={{ opacity: 0, x: -10 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          className="font-ui text-[12px] tracking-[0.3em] text-irun-terracotta uppercase block mb-6 relative z-10"
        >
          Texture & Qualité
        </motion.span>
        ...
        <motion.h2
          ...
          className="font-serif text-[clamp(40px,4.5vw,64px)] text-irun-black leading-[1.05] mb-8 relative z-10"
        >
        ...
        <motion.p
          ...
          className="font-sans font-light text-[17px] text-irun-black-muted leading-[1.7] max-w-xl mb-12 relative z-10"
        >
        ...
        <motion.div
          ...
          className="h-[2px] bg-irun-terracotta mb-12 origin-left relative z-10"
        />
        ...
        >
          <button className="btn-irun-ghost group">
